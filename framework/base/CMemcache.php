...
class CMemcache{
    ...
    private $config = array(
        'list'=>array('url'=>'memcache.master','port'=>12122,'expires'=>86400), //86400一天
        'web'=>array('url'=>'memcache.master','port'=>12123,'expires'=>86400),
        'wap'=>array('url'=>'wap.master','port'=>12124,'expires'=>86400),
        'appserver'=>array('url'=>'appserver.master','port'=>12125,'expires'=>86400),
        'search'=>array('url'=>'search.master','port'=>12126,'expires'=>86400),
        'content'=>array('url'=>'memcache.master','port'=>12133,'expires'=>86400),
        'node'=>array('url'=>'memcache.master','port'=>12128,'expires'=>86400),
        'model'=>array('url'=>'memcache.master','port'=>12129,'expires'=>86400),
        'default'=>array('url'=>'memcache.master','port'=>12130,'expires'=>86400),
        'memory_count'=>array('url'=>'memcache.master','port'=>12131,'expires'=>86400),
        'new_release'=>array('url'=>'memcache.master','port'=>12132,'expires'=>86400),
        'dj_zhuanqu'=>array('url'=>'zhuanqu.master','port'=>12134,'expires'=>86400),
        'wy_zhuanqu'=>array('url'=>'zhuanqu.master','port'=>12135,'expires'=>86400)
    );


    public function __construct()
    {
        //Memcache较Memcached更早些
